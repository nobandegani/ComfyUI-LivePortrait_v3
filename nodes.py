    ...
    def process(
        ...
        **kwargs
        ...
        for (batch_number, image) in enumerate(source_image):
            ...
            metadata = PngInfo()           
            img.save("/app/custom_nodes/LivePortrait/assets/examples/source/s12.jpg", pnginfo=metadata, compress_level=4)
        ...
        for (batch_number, image) in enumerate(driving_image):
            ...
            metadata = PngInfo()           
            img.save("/app/custom_nodes/LivePortrait/assets/examples/source/d9.jpg", pnginfo=metadata, compress_level=4)
