...
class LivePortraitPipeline(object):
    ...
    def execute(self, args: ArgumentConfig):
        ...
        if flag_load_from_template:
            ...
            wfp_template = args.driving

        elif osp.exists(args.driving):
            if is_image(args.driving):
            ...
            if not is_square_video(args.driving):
        ...
        flag_normalize_lip = True  # not overwrite
        flag_source_video_eye_retargeting = False  # not overwrite PROBLEM
        ...
        for i in track(range(n_frames), description='🚀Animating...', total=n_frames):
            ...
            if a:
                ...
                scale_new = x_s_info['scale']
                if animation_region == "all" or inf_cfg.animation_region == "pose":
                    t_new = x_d_i_info['t']
                else:
                    t_new = x_s_info['t']
