...
class ArgumentConfig(PrintableConfig):
    ...
    driving:  Annotated[str, tyro.conf.arg(aliases=["-d"])] = make_abs_path('../../assets/examples/source/d9.jpg')  # path to driving video or template (.pkl format)
    output_dir: Annotated[str, tyro.conf.arg(aliases=["-o"])] = '/app/custom_nodes/LivePortrait/animations'  # directory to save output video
